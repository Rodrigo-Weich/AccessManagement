        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.cardgroups.store') }}" method="post">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select name="cards[]" class="mselectCards form-control" multiple="true">
                                    @foreach($data as $index)
                                        <option value="{{ $index->id }}">@if($index->owner != 1){{ Str::limit($index->name, 50) }}@else {{ Str::limit($index->name, 50) }}*@endif</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <span class="float-right">
                            <a class="btn btn-danger" href="{{ route('user.cardgroups.index') }}" role="button" data-toggle="tooltip"
