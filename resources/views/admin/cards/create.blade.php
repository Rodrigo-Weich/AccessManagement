                    ...
                    <form action="{{ route('admin.cards.store') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputlogin" name="login" value="{{ old('login') }}" autofocus>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputpassword">{{ __('Page password') }}</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" name="password" id="inputPassword" value="{{ old('password') }}" autofocus>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="inputurl" name="url" value="{{ old('url') }}" autofocus>
                        ...
                        <span class="float-right">
                            <a class="btn btn-danger" href="{{ route('admin.cards.index') }}" role="button" data-toggle="tooltip"
