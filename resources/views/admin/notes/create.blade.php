                    ...
                    <form action="{{ route('admin.notes.store') }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" id="textareadescription" rows="15" name="description" autofocus>{{ old('description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <span class="float-right">
                            <a class="btn btn-danger" href="{{ route('admin.notes.index') }}" role="button" data-toggle="tooltip"
