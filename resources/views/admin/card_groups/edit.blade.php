        ...
        <div class="col-md-10">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.cardgroups.update', $card) }}" method="post">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="form-row">
                        ...
                        <span class="float-right">
                            <a class="btn btn-danger" href="{{ route('admin.cardgroups.index') }}" role="button" data-toggle="tooltip" data-placement="top" title="{{ __('Cancel and return') }}"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
